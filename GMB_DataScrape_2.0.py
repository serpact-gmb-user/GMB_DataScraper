   ...
   #     driver.close()
    ...
    try:
        ...
        for row in csv_reader:
            ...
            logger.info(f"Number of iterations to perform: {page_counter}")

            # Loop over the range of pages, extract web elements from table data/table rows.
            for i in range(page_counter + 1):
                element = driver.find_element_by_xpath('//*[@id="search-keywords"]/div/span/div[2]/div[1]/table').text
                logger.info(f"Current web element value: \n{element}")
